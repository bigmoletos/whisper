...
if !ERRORLEVEL! neq 0 (
    echo.
    echo AVERTISSEMENT: Version de Python incompatible
...
if !ERRORLEVEL! neq 0 (
    echo.
    echo AVERTISSEMENT: Certaines dépendances sont manquantes ou l'installation a échoué
...
:error
echo.
echo AVERTISSEMENT: Erreur lors de la vérification des dépendances
